...
//        assert Skid ? PedalPos == 4 : true;

        System.out.println("printing state result:");
        System.out.println("(Alt_Pressure, Nor_Pressure, Sys_Mode) = " + Alt_Pressure + "," + Nor_Pressure + "," + Sys_Mode);
