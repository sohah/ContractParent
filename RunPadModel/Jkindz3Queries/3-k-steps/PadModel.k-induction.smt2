...
(assert (T false $sig$1 $ignition$1 $reset_flag$1 $p1$1 $start_bt_val~0.start_bt$1 $start_bt_val~0.launch_bt$1 $start_bt_val~0.reset_flag$1 $start_bt_val~0.start_bt_out$1 $launch_bt_val~0.start_bt$1 $launch_bt_val~0.launch_bt$1 $launch_bt_val~0.reset_flag$1 $launch_bt_val~0.launch_bt_out$1 $Y~0.in$1 $Y~0.out$1 $sig$2 $ignition$2 $reset_flag$2 $p1$2 $start_bt_val~0.start_bt$2 $start_bt_val~0.launch_bt$2 $start_bt_val~0.reset_flag$2 $start_bt_val~0.start_bt_out$2 $launch_bt_val~0.start_bt$2 $launch_bt_val~0.launch_bt$2 $launch_bt_val~0.reset_flag$2 $launch_bt_val~0.launch_bt_out$2 $Y~0.in$2 $Y~0.out$2))
(assert true)
...
(echo "@DONE")
; Z3: (model 
; Z3:   (define-fun $ignition$2 () Bool
; Z3:     true)
; Z3:   (define-fun $reset_flag$1 () Bool
; Z3:     true)
; Z3:   (define-fun $start_bt_val~0.start_bt_out$2 () Bool
; Z3:     false)
; Z3:   (define-fun $launch_bt_val~0.launch_bt_out$~1 () Bool
; Z3:     true)
; Z3:   (define-fun $launch_bt_val~0.launch_bt_out$1 () Bool
...
; Z3:   (define-fun $Y~0.in$0 () Bool
; Z3:     false)
; Z3:   (define-fun $start_bt_val~0.launch_bt$2 () Bool
; Z3:     true)
; Z3:   (define-fun $ignition$0 () Bool
; Z3:     true)
; Z3:   (define-fun $launch_bt_val~0.start_bt$0 () Bool
...
; Z3:   (define-fun $sig$0 () Int
; Z3:     1)
; Z3:   (define-fun $launch_bt_val~0.launch_bt$2 () Bool
; Z3:     true)
; Z3:   (define-fun $start_bt_val~0.start_bt_out$~1 () Bool
; Z3:     false)
; Z3:   (define-fun $launch_bt_val~0.launch_bt_out$0 () Bool
...
; Z3:   (define-fun $start_bt_val~0.start_bt$1 () Bool
; Z3:     false)
; Z3:   (define-fun $Y~0.out$2 () Bool
; Z3:     false)
; Z3:   (define-fun $start_bt_val~0.reset_flag$1 () Bool
; Z3:     false)
; Z3:   (define-fun $reset_flag$2 () Bool
; Z3:     false)
...
; Z3:   (define-fun $launch_bt_val~0.launch_bt$0 () Bool
; Z3:     true)
; Z3:   (define-fun $p1$2 () Bool
; Z3:     false)
; Z3:   (define-fun $sig$1 () Int
; Z3:     1)
; Z3:   (define-fun $p1$1 () Bool
; Z3:     true)
; Z3:   (define-fun $start_bt_val~0.reset_flag$2 () Bool
; Z3:     true)
; Z3:   (define-fun $launch_bt_val~0.reset_flag$2 () Bool
; Z3:     true)
; Z3:   (define-fun $start_bt_val~0.launch_bt$1 () Bool
; Z3:     false)
; Z3:   (define-fun $reset_flag$0 () Bool
...
; Z3:   (define-fun %init () Bool
; Z3:     false)
; Z3:   (define-fun $launch_bt_val~0.launch_bt_out$2 () Bool
; Z3:     false)
; Z3:   (define-fun $start_bt_val~0.launch_bt$0 () Bool
; Z3:     true)
; Z3:   (define-fun $Y~0.out$1 () Bool
...
; Z3:   (define-fun $start_bt_val~0.start_bt_out$0 () Bool
; Z3:     false)
; Z3:   (define-fun $launch_bt_val~0.start_bt$2 () Bool
; Z3:     false)
; Z3:   (define-fun $start_bt_val~0.start_bt$2 () Bool
; Z3:     false)
; Z3:   (define-fun $start_bt_val~0.reset_flag$0 () Bool
; Z3:     true)
...
(assert (T false $sig$2 $ignition$2 $reset_flag$2 $p1$2 $start_bt_val~0.start_bt$2 $start_bt_val~0.launch_bt$2 $start_bt_val~0.reset_flag$2 $start_bt_val~0.start_bt_out$2 $launch_bt_val~0.start_bt$2 $launch_bt_val~0.launch_bt$2 $launch_bt_val~0.reset_flag$2 $launch_bt_val~0.launch_bt_out$2 $Y~0.in$2 $Y~0.out$2 $sig$3 $ignition$3 $reset_flag$3 $p1$3 $start_bt_val~0.start_bt$3 $start_bt_val~0.launch_bt$3 $start_bt_val~0.reset_flag$3 $start_bt_val~0.start_bt_out$3 $launch_bt_val~0.start_bt$3 $launch_bt_val~0.launch_bt$3 $launch_bt_val~0.reset_flag$3 $launch_bt_val~0.launch_bt_out$3 $Y~0.in$3 $Y~0.out$3))
(assert true)
(declare-fun act4 () Bool)
(assert (=> act4 (not (=> (and $p1$0 $p1$1 $p1$2) $p1$3))))
(check-sat act4)
(echo "@DONE")
; Z3: unsat
; Z3: @DONE
