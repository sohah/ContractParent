...
(assert (=> act1 (not (and false (= $sig$0 0) (= $sig$0 1) (= $sig$0 2) $p1$0 (not $p1$0) $reset_flag$0 (not $reset_flag$0) $start_bt$0 (not $start_bt$0) $launch_bt$0 (not $launch_bt$0) $ignition$0 (not $ignition$0)))))
(check-sat act1)
(echo "@DONE")
; Z3: sat
; Z3: @DONE
...
(assert (=> act2 (not (and (not (= $sig$0 1)) (not (= $sig$0 2)) $p1$0 (not $reset_flag$0) (not $start_bt$0) (not $launch_bt$0) (not $ignition$0) (= $sig$0 0) $p1$0 (not $reset_flag$0) (not $start_bt$0) (not $launch_bt$0) (not $ignition$0) (=> false true)))))
(check-sat act2)
(echo "@DONE")
; Z3: sat
; Z3: @DONE
