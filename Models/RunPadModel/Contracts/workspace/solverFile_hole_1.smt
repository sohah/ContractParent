...
(declare-fun test_case_1() bool)
(declare-fun antecedent_1() bool)
(declare-fun consequent_1() bool)
(assert (= antecedent_1 (and
    (= %init false )
    (= signal$r0 0)
    (= signal$r1 2)
    (= $sig$0 0)
    ...
    ;(= $p1$1 true )
    (= r347.launch_btn.1.9.4$r1 1)
    (= r347.launch_btn.1.9.4$r0 1)
    (= r347.launch_btn.1.3.4$r0 1)
    (= r347.launch_btn.1.3.4$r1 1)
    (= r347.start_btn.1.5.4$r1 1)
    (= r347.launch_btn.1.13.4$r1 0)
    (= r347.start_btn.1.5.4$r0 1)
    (= r347.launch_btn.1.13.4$r0 1)
    (= r347.reset_btn.1.7.4$r0 1)
    (= r347.reset_btn.1.7.4$r1 0)
    (= r347.start_btn.1.7.4$r0 1)
    (= r347.start_btn.1.7.4$r1 1)
    (= r347.launch_btn.1.5.4$r1 1)
    (= r347.launch_btn.1.5.4$r0 1)
    (= r347.start_btn.1.11.4$r1 0)
    (= r347.reset_btn.1.4.4$r1 0)
    (= r347.launch_btn.1.15.4$r0 1)
    (= r347.reset_btn.1.4.4$r0 0)
    (= r347.start_btn.1.3.4$r1 1)
    (= r347.start_btn.1.11.4$r0 1)
    (= r347.ignition_r.1.5.4$r1 0)
    (= r347.launch_btn.1.15.4$r1 0)
    (= r347.start_btn.1.13.4$r1 0)
    (= r347.start_btn.1.13.4$r0 1)
    (= r347.ignition_r.1.4.4$r1 0)
    (= r347.ignition_r.1.5.4$r0 0)
    (= r347.ignition_r.1.4.4$r0 0)
    (= r347.reset_btn.1.5.4$r0 1)
    (= r347.reset_btn.1.5.4$r1 0)
    (= r347.launch_btn.1.11.4$r0 1)
    (= r347.start_btn.1.9.4$r1 0)
    (= r347.start_btn.1.3.4$r0 1)
    (= r347.start_btn.1.9.4$r0 1)
    (= r347.launch_btn.1.11.4$r1 0)
    (= r347.launch_btn.1.7.4$r1 1)
    (= r347.launch_btn.1.7.4$r0 1)
...
(assert (= consequent_1 (and
          (= r347.reset_btn.1.9.4$r1 0)
          (= r347.ignition_r.1.7.4$r1 0)
          (= r347.launch_btn.1.17.4$r1 0)
          (= r347.start_btn.1.15.4$r1 0)
          (= $p1$1 true ))))

(assert (= test_case_1 (=> antecedent_1 consequent_1)))
