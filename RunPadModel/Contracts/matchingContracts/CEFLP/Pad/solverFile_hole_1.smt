...
(and
  (= $start_bt$1(ite %init  constHole_1 (ite $reset_flag$0  constHole_2 (ite(and(and(not $start_bt$0)(not $launch_bt$0))(= $sig$1  constHole_3 ))  constHole_4  $start_bt$0))))
  (= $launch_bt$1(ite %init  constHole_5 (ite $reset_flag$0  constHole_6 (ite(and(and $start_bt$0(not $launch_bt$0))(= $sig$1  constHole_7 ))  constHole_8  $launch_bt$0))))
  (= $ignition$1(ite %init  constHole_9 (and $launch_bt$0(and(not $ignition$0)(not $reset_flag$0)))))
  (= $reset_flag$1(ite %init  constHole_10 (and $ignition$0(not $reset_flag$0))))
  (= $p1$1 $H~0.out$1)
  (= $H~0.in$1(=> $reset_flag$1 $Y~0.out$1))
  (= $H~0.out$1(ite %init $H~0.in$1(and $H~0.in$1 $H~0.out$0)))
  (= $Y~0.out$1(ite %init  constHole_11  $ignition$0))))
