...
(assert (or  antecedent_0 antecedent_1))
(assert (= antecedent_0 (and(= signal$r0 1)(= start_btn$r0 0)(= reset_btn$r0 0)(= ignition$r0 0)(= launch_btn$r0 0)(= signal$r1 0)(= r347.reset_btn.1.9.4$r0 0)(= r347.ignition_r.1.7.4$r0 0)(= r347.launch_btn.1.17.4$r0 0)(= r347.start_btn.1.15.4$r0 0)(= $p1$~1 true )(= $p1$0 true ))))
(assert (= antecedent_1 (and(= signal$r0 2)(= start_btn$r0 1)(= reset_btn$r0 1)(= ignition$r0 0)(= launch_btn$r0 1)(= signal$r1 0)(= r347.reset_btn.1.9.4$r0 0)(= r347.ignition_r.1.7.4$r0 0)(= r347.launch_btn.1.17.4$r0 0)(= r347.start_btn.1.15.4$r0 0)(= $p1$~1 true )(= $p1$0 true ))))
(assert (=> antecedent_0 (and(= r347.reset_btn.1.9.4$r1 0)(= r347.ignition_r.1.7.4$r1 0)(= r347.launch_btn.1.17.4$r1 0)(= r347.start_btn.1.15.4$r1 1)(= $p1$1 true ))))
